    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="{{ asset('images/sate-kelapa.jpg') }}" alt="" width="60px" height="30px">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Dokumentasi untuk
                                Medicine Store</h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Ini loh dokumentasinya tentang medicine store. Have fun and happy coding 🎉✅
                            </p>
                        </div>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    Hello Medicine Store by David Pratama
                </div>
            </div>
        </div>
    </div>
